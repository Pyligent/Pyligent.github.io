...
```
 ![Total car sales on kijiji website in GTA area based on Model Year](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_car_count.png)
...
```
    ...
    and BMW
```
 ![Brand Numbers on kijiji website in GTA area](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_brand_count.png)
...
```
   ...
   have lower mileages.
```
 ![Average Mileages based on Brands on Kijiji website](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_brand_mean_mileage.png)

- **Average Price based on Brands on Kijiji website**
```
   Luxury brand used cars still have high re-sell values
 ```
 ![Average Price based on Brands on Kijiji website](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_brand_mean_price.png)
...
```
   ...
   ```
 ![Average List Price vs Average Mileage  Kernel Density Estimate plot](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/Dist_mean_pricemile.png)

- **Average price of vehicles by vehicle type and brand**
 ![Average price of vehicles by vehicle type and brand](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_type_price.png)

- **Average mileage of vehicles by vehicle type and brand**
 ![Average mileage of vehicles by vehicle type and brand](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_type_mileage.png)
...
```
 ![Mercedes-Benz Used Cars Data Analysis](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_benz1.png)
 ...
 ```
 ![Color Analysis](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/kijiji_color.png)
...
![Price vs. Miles per Galon - cars made in 2015 (USA)](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/auto_trader_price2015_MPG.png)

- **Displacement vs. Miles per Galon (USA data)**

![Displacement vs. Miles per Galon (USA data)](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/auto_trader_displacement_MPG.png)

- **Price vs. Displacement - cars made in 2015 (USA)**

![Price vs. Displacement - cars made in 2015 (USA)](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/auto_trader_price2015_displacement.png)

- **[MPG by make (USA data)]**

![MPG by make (USA data)](https://github.com/Pyligent/Car_ETL_PROJECT/blob/master/plot_image/auto_trader_make_MPG.png)
